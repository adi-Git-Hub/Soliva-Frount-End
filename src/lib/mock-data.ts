...
export const mockProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "A radiance-boosting blend of botanicals and vitamin C for a quiet luminosity.",
    priceCents: 7200,
    compareAtCents: null,
    currency: "USD",
    images: [
  ...
  },
  {
    ...
    description:
      "Rich overnight balm that wakes skin soft, plumped, and quietly luminous.",
    priceCents: 6800,
    compareAtCents: null,
    currency: "USD",
    images: [
      "https://images.unsplash.com/photo-1601612628452-9e99ced43524?w=900&q=80",
    ],
    categoryId: "cat_1",
    categorySlug: "skincare",
    inStock: true,
  ...
  },
  {
    ...
    description:
      "Notes of cedarwood, amber, and white pepper — soft yet unmistakable.",
    priceCents: 11800,
    compareAtCents: null,
    currency: "USD",
    images: [
  ...
  },
  {
    ...
    description:
      "A softly powdered floral built on jasmine, peony, and warm musk.",
    priceCents: 9400,
  ...
  },
  {
    ...
    currency: "USD",
    images: [
      "https://images.unsplash.com/photo-1591348278863-a8fb3887e2aa?w=900&q=80",
    ],
    categoryId: "cat_3",
  ...
  },
  {
    ...
    description:
      "Slip-cast porcelain disk with a brushed gold inlay — a quiet object.",
    priceCents: 4400,
    compareAtCents: null,
    currency: "USD",
    images: [

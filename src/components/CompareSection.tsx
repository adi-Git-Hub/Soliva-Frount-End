      ...
      <div className="relative mx-auto max-w-[90rem] px-4 md:px-8 z-10">
        ...
        >
              ...
              <div className="relative z-10">
                ...
                <div className="mb-7 sm:mb-8 lg:mb-10 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-xl border-y border-brown/15 bg-[#F3ECE2]/40 px-3 sm:px-4 py-4 sm:py-6 lg:py-8 shadow-[inset_0_1px_1px_rgba(255,255,255,0.5)] transition-all duration-700 group-hover/old:bg-[#F3ECE2]/60">
                  <div className="space-y-1.5 sm:space-y-2">
                    ...
                    <span className="block text-lg sm:text-xl md:text-2xl font-mono italic tracking-tighter text-brown/70 transition-colors group-hover/old:text-brown-deep">≤ 15</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2 border-x border-brown/15 px-2 sm:px-4 md:px-6">
                    ...
                    <span className="block text-lg sm:text-xl md:text-2xl font-mono italic tracking-tighter text-brown/70 transition-colors group-hover/old:text-brown-deep">18×</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2">
                    <span className="block text-[8px] text-brown/60 uppercase font-mono tracking-widest font-bold">Cover</span>
                    <span className="block text-lg sm:text-xl md:text-2xl font-mono italic tracking-tighter text-brown/70 transition-colors group-hover/old:text-brown-deep">Partial</span>
                  </div>
                </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mb-7 sm:mb-9 lg:mb-12 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-2xl border-y border-orange-glow/20 bg-white/95 px-3 sm:px-5 lg:px-6 py-5 sm:py-7 lg:py-10 shadow-[0_15px_40px_-10px_rgba(58,42,34,0.1),inset_0_1px_0_rgba(255,255,255,0.9)] transition-all duration-700 group-hover/card:bg-white">
                  <div className="space-y-1.5 sm:space-y-2">
                    <span className="block text-[8px] sm:text-[9px] text-orange-glow uppercase font-mono tracking-widest font-black">UPF</span>
                    <span className="block font-mono font-black tracking-tighter text-brown-deep transition-transform duration-500 group-hover/card:scale-110 origin-left" style={{ fontSize: "clamp(1.6rem, 5vw, 2.75rem)" }}>50+</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2 border-x border-orange-glow/20 px-2 sm:px-4 md:px-6">
                    <span className="block text-[8px] sm:text-[9px] text-orange-glow uppercase font-mono tracking-widest font-black">Adj/Hr</span>
                    <span className="block font-mono font-black tracking-tighter text-brown-deep transition-transform duration-500 group-hover/card:scale-110" style={{ fontSize: "clamp(1.6rem, 5vw, 2.75rem)" }}>0×</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2">
                    <span className="block text-[8px] sm:text-[9px] text-orange-glow uppercase font-mono tracking-widest font-black">Cover</span>
                    <span className="block font-mono font-black tracking-tighter text-brown-deep transition-transform duration-500 group-hover/card:scale-110 origin-right" style={{ fontSize: "clamp(1.6rem, 5vw, 2.75rem)" }}>360°</span>
                  </div>
                </div>
          ...
          <div className="relative z-10 mt-10 sm:mt-16 space-y-5 sm:space-y-6 text-center">
            ...
            >
              Protection shouldn’t depend on <span className="italic font-serif text-orange-glow underline underline-offset-[8px] sm:underline-offset-[12px] decoration-orange-glow/30 decoration-2">adjustment.</span>
            </motion.h4>
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}

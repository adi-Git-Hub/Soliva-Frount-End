...
export function CompareSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full overflow-hidden bg-luxury-beige pt-8 sm:pt-8 md:pt-10 pb-0 z-20"
    >
      ...
      <div className="relative mx-auto max-w-[90rem] px-4 md:px-8 z-10">
        ...
        <motion.div
          ...
          className="relative bg-surface-panel border border-line-soft rounded-panel-sm sm:rounded-panel-lg md:rounded-shell xl:rounded-shell-lg p-5 sm:p-8 md:p-10 lg:px-14 lg:pt-8 lg:pb-12 xl:px-20 xl:pt-10 xl:pb-16 backdrop-blur-medium shadow-editorial inset-shadow-cream overflow-hidden"
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center mb-8 sm:mb-10">
            ...
            <motion.h2
              ...
              className="font-display text-brown-deep leading-hero mb-8 sm:mb-10 tracking-tighter text-display-xl"
            >
              Still using a dupatta or<br />
              <span className="italic text-brown-deep">
                regular scarf?
              </span>
            </motion.h2>
          ...
          <div className="relative flex flex-col md:flex-row items-stretch gap-5 sm:gap-8 perspective-2000 z-10">
            ...
            <motion.div
              ...
              className="flex-1 relative bg-[#EBE5DE]/80 border border-line-strong rounded-panel-sm sm:rounded-panel-lg p-5 sm:p-8 lg:p-10 xl:p-12 backdrop-blur-medium transition-all duration-1000 group/old shadow-floating overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <header className="mb-7 sm:mb-8 lg:mb-10">
                  <span className="mb-3 sm:mb-4 block font-mono text-micro-xs sm:text-micro-sm uppercase font-bold tracking-eyebrow sm:tracking-luxe text-ink-muted">
                    01 // CONVENTIONAL
                  </span>
                  <h3 className="mb-3 sm:mb-4 font-display text-2xl sm:text-3xl md:text-4xl tracking-tight text-brown-deep/70 transition-colors duration-700 group-hover/old:text-brown-deep">
                ...
                <div className="mb-7 sm:mb-8 lg:mb-10 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-xl border-y border-line-medium bg-[#F3ECE2]/40 px-3 sm:px-4 py-4 sm:py-6 lg:py-8 inset-shadow-line transition-all duration-700 group-hover/old:bg-[#F3ECE2]/60">
                  <div className="space-y-1.5 sm:space-y-2">
                    <span className="block text-micro-xs text-ink-muted uppercase font-mono tracking-widest font-bold">UPF</span>
                    <span className="block text-lg sm:text-xl md:text-2xl font-mono italic tracking-tighter text-ink-soft transition-colors group-hover/old:text-brown-deep">≤ 15</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2 border-x border-line-medium px-2 sm:px-4 md:px-6">
                ...
                <div className="pt-8 border-t border-line-medium">
            ...
            <motion.div
              ...
              className="flex-[1.1] relative bg-[#FDFBF7]/95 border border-line-accent rounded-panel-sm sm:rounded-panel-lg p-5 sm:p-8 lg:p-10 xl:p-14 backdrop-blur-medium shadow-editorial inset-shadow-cream group/card overflow-hidden transition-all duration-700"
            >
              ...
              <div className="relative z-10">
                <header className="mb-7 sm:mb-9 lg:mb-12">
                  ...
                  <h3 className="mb-5 sm:mb-6 font-display text-3xl sm:text-4xl md:text-5xl tracking-tight leading-none text-brown-deep">
                ...
                <div className="mb-7 sm:mb-9 lg:mb-12 grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 rounded-2xl border-y border-line-accent bg-surface-glass-strong px-3 sm:px-5 lg:px-6 py-5 sm:py-7 lg:py-10 shadow-floating inset-shadow-line transition-all duration-700 group-hover/card:bg-white">
                  <div className="space-y-1.5 sm:space-y-2">
                    <span className="block text-micro-xs sm:text-micro-sm text-orange-glow uppercase font-mono tracking-widest font-bold">UPF</span>
                    <span className="block font-mono font-black tracking-tighter text-brown-deep transition-transform duration-500 group-hover/card:scale-110 origin-left text-display-metric">50+</span>
                  </div>
                  <div className="space-y-1.5 sm:space-y-2 border-x border-line-accent px-2 sm:px-4 md:px-6">
                ...
                <div className="pt-8 sm:pt-10 border-t border-line-accent">
          ...
          <div className="relative z-10 mt-12 sm:mt-20 space-y-5 sm:space-y-6 text-center">
            <motion.h4

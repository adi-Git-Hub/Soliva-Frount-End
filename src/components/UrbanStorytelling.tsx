  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          <div className="relative flex w-full md:h-full md:w-1/2 items-center bg-transparent px-4 sm:px-6 md:px-8 lg:px-10 xl:px-14 py-14 sm:py-16 md:py-0 flex-shrink-0 overflow-visible">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-14 items-center w-full max-w-[1400px] mx-auto relative z-10 overflow-visible">
              ...
              <div ref={p2TextRef} className="space-y-5 sm:space-y-6 md:space-y-8 bg-surface-panel border border-line-hairline rounded-panel-sm sm:rounded-panel md:rounded-panel-lg p-5 sm:p-6 md:p-7 backdrop-blur-medium shadow-sm">
        ...
        {/* LUXURY FOOTER STRIP */}
        <div className="hidden md:flex fixed bottom-0 left-0 right-0 z-50 w-full px-12 lg:px-16 py-4 items-center border-t border-line-soft bg-luxury-beige/95 backdrop-blur-medium shadow-strip-top">
          {/* LEFT — System metadata */}
          <div className="flex flex-1 items-center gap-8 min-w-0">
            <div className="opacity-90 hover:opacity-100 transition-opacity duration-500 pr-8 border-r border-line-soft shrink-0">
              <SolivaLogo height={22} />
            </div>
            <div className="flex flex-col gap-1.5 min-w-0">
              <span className="font-mono text-micro-md tracking-luxe text-brown-deep uppercase leading-none text-nowrap font-bold">
                SYSTEM ARCHIVE
                <span className="ml-3 text-orange-glow font-black tracking-cta">
                  26.01
                </span>
              </span>
              <span className="font-mono text-micro-xs tracking-eyebrow text-ink-soft uppercase leading-none text-nowrap">
                MILAN · PARIS · TOKYO
              </span>
            </div>
          </div>

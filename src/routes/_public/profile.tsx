          ...
          >
            <div className="flex flex-col items-center text-center mb-8 sm:mb-10">
              <div className="relative mb-3 sm:mb-4 group">
                <div className="h-20 w-20 sm:h-24 sm:w-24 rounded-full bg-cream border border-line-soft flex items-center justify-center overflow-hidden shadow-inner group-hover:shadow-lg transition-all duration-500">
                  <User className="h-9 w-9 sm:h-10 sm:w-10 text-ink-faint" />
                </div>
